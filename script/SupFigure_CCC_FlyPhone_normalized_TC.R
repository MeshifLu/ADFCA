...
for (genotype in genotype_V) {
  ...
  ### create folders
  output_dir <- paste0('~/Project/ADFCA/Analysis/Figure/FigureCCC/', genotype)
  ...
  ### load serurat files
  seuratObj <- readRDS(paste0("~/Project/ADFCA/Analysis/Figure/FigureCCC/seuratObj_", genotype, ".rds"))
